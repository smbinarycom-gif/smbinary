...
interface ApprovedWithdrawalsProps {
  paymentRequests: PaymentRequest[];
  onProcessPayment: (reqId: string, action: 'APPROVED' | 'REJECTED') => void;
  onViewProof: (url: string) => void;
}

const ApprovedWithdrawals: React.FC<ApprovedWithdrawalsProps> = ({ paymentRequests, onProcessPayment, onViewProof }) => {
  const withdrawals = useMemo(
    () => paymentRequests.filter((req) => req.type === 'WITHDRAWAL' && req.status === 'APPROVED'),
    [paymentRequests]
  );
