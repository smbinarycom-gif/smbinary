...
interface SuccessfulDepositsProps {
  paymentRequests: PaymentRequest[];
  onProcessPayment: (reqId: string, action: 'APPROVED' | 'REJECTED') => void;
  onViewProof: (url: string) => void;
}

const SuccessfulDeposits: React.FC<SuccessfulDepositsProps> = ({ paymentRequests, onProcessPayment, onViewProof }) => {
  const deposits = useMemo(
    () => paymentRequests.filter((req) => req.type === 'DEPOSIT' && req.status === 'APPROVED'),
    [paymentRequests]
  );
