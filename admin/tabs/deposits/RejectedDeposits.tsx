...
interface RejectedDepositsProps {
  paymentRequests: PaymentRequest[];
  onProcessPayment: (reqId: string, action: 'APPROVED' | 'REJECTED') => void;
  onViewProof: (url: string) => void;
}

const RejectedDeposits: React.FC<RejectedDepositsProps> = ({ paymentRequests, onProcessPayment, onViewProof }) => {
  const deposits = useMemo(
    () => paymentRequests.filter((req) => req.type === 'DEPOSIT' && req.status === 'REJECTED'),
    [paymentRequests]
  );
