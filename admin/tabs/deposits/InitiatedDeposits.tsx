...
interface InitiatedDepositsProps {
  paymentRequests: PaymentRequest[];
  onProcessPayment: (reqId: string, action: 'APPROVED' | 'REJECTED') => void;
  onViewProof: (url: string) => void;
}

const InitiatedDeposits: React.FC<InitiatedDepositsProps> = ({ paymentRequests, onProcessPayment, onViewProof }) => {
