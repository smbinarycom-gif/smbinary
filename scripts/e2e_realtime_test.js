#!/usr/bin/env node
/*
 End-to-end realtime test using Supabase JS client.
 Requires: SUPABASE_URL and SUPABASE_SERVICE_KEY env vars.
 This script will:
  - open a realtime subscription to `transactions`
  - insert a test transaction (REQUESTED)
  - call RPC `process_transaction_update` to mark COMPLETED and update balance
  - verify audit record and final status
*/
...
async function run() {
  ...
  // If no TEST_USER_ID provided, create a short-lived test user via admin API
  if (!userId) {
