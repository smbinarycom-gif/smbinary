#!/usr/bin/env node
/*
 Run migrations against a Postgres database using DATABASE_URL env var.
 Usage: DATABASE_URL="postgres://..." node scripts/apply_migrations.js
*/
const fs = require('fs');
...
async function run() {
  ...
  try {
    ...
    for (const m of migrations) {
      ...
      // split on \n; many scripts contain multiple statements; use simple approach
