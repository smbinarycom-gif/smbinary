...
const PortalSelection: React.FC<PortalSelectionProps> = ({ onSelect }) => {
  return (
    <div className="min-h-[100dvh] w-screen bg-[#f8fafc] flex flex-col items-center justify-center px-4 sm:px-6 py-8 space-y-10 sm:space-y-12 overflow-hidden">
      <div className="text-center space-y-2 max-w-xs sm:max-w-none">
        <div className="inline-block px-3 sm:px-4 py-1.5 bg-[#8b5cf6]/5 rounded-full border border-[#8b5cf6]/10 mb-3 sm:mb-4">
          <span className="text-[10px] font-black text-[#8b5cf6] tracking-[4px] uppercase">Enterprise Protocol</span>
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black tracking-tighter text-slate-900 italic leading-tight break-words">
          GEMINI<span className="text-[#8b5cf6]">X</span>
        </h1>
        <p className="text-slate-400 text-[11px] sm:text-xs font-bold uppercase tracking-[1.5px] sm:tracking-[2px]">
          Select your destination portal to begin
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 w-full max-w-4xl">
        <button 
          ...
          className="group relative bg-white border border-slate-200 p-6 sm:p-10 rounded-[28px] sm:rounded-[40px] flex flex-col items-center text-center space-y-5 sm:space-y-6 transition-all hover:border-[#8b5cf6]/40 hover:shadow-xl active:scale-95"
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-500 text-[10px] sm:text-[11px] font-medium leading-relaxed uppercase tracking-wider">
              Access live markets, analyze charts,
              <br />
              and execute binary trades.
            </p>
          </div>
          <div className="pt-4">
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-500 text-[10px] sm:text-[11px] font-medium leading-relaxed uppercase tracking-wider">
              Manage assets, control market bias,
              <br />
